...
$host = '127.0.0.1'; // hoặc localhost [cite: 33]
...
try {
    // TODO 1: Tạo đối tượng PDO để kết nối CSDL [cite: 39]
...
if (isset($_POST['ten_sinh_vien'])) { 
    ...
    // TODO 6: Chuyển hướng về chính trang này để "làm mới" (Tránh POST dữ liệu lặp lại)
...
<body>
    ...
    <table>
        ...
        <?php
        // TODO 9 & 10: Dùng vòng lặp để duyệt qua kết quả và in ra dữ liệu
        while ($row = $stmt_select->fetch(PDO::FETCH_ASSOC)) {
            echo "<tr>"; 
            echo "<td>" . htmlspecialchars($row['id']) . "</td>"; // Sử dụng htmlspecialchars để bảo mật [cite: 102, 103]
